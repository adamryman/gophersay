...
func gopherAscii() (*asset, error) {
	bytes, err := gopherAsciiBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "gopher.ascii", size: 431, mode: os.FileMode(436), modTime: time.Unix(1468531021, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"gopher.ascii": &bintree{gopherAscii, map[string]*bintree{}},
}}
